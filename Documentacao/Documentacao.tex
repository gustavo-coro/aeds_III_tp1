...
\begin{document}
    ...
    \section{COMPLEXIDADE}
        ...
        essa? %Vamos observar a função de custo desse algoritmo:\\
        %\[f(n) = \frac{n^2}{2}-\frac{n}{2}\]\\
        Observando cada parte do algoritmo notamos que o laço interno é executado n vezes, \\  
        %Observando cada parte do algoritmo observamos que o laço mais externo é executado \textbf{n-1} 
        %vezes, pois o mesmo ja inicia na segunda posição do vetor \textbf{i=1}, sendo assim o primeiro 
        %termo da função. Já o laço interno é executado \textbf{i-1} vezes, ou seja, ao final será \textbf{(n-1)-1}.
        %Abrindo a função fica o seguinte:\\
